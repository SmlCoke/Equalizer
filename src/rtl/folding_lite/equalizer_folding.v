...
module equalizer_folding #(
    ...
    // 组合逻辑的乘法器，截去 4 个低位小数位以降低后级累加位宽
    wire signed [15:0] mult_full;
    wire signed [11:0] mult_out;
    assign mult_full = mux_data * mux_coeff;
    assign mult_out  = mult_full[15:4];
    
    reg signed [11:0] mult_out_d [0:7];
    ...
    // ------------------- 4. 加法器 -------------------
    // 加法器的输入数据
    reg  signed [18:0] add_in_1;
    reg  signed [18:0] add_in_2;
    wire signed [18:0] add_out;
    reg  signed [18:0] add_out_d;

    always @(*) begin
        case (fold_cnt)
            3'b000:  begin add_in_1 = 19'sd0;        add_in_2 = 19'sd0;         end
            ...
            default: begin add_in_1 = 19'sd0;        add_in_2 = 19'sd0;        end
        endcase
    end

    // 组合逻辑的加法器 
    assign add_out = fold_cnt == 3'b000 ? 19'sd0 : add_in_1 + add_in_2;
